from tkinter import HORIZONTAL, LEFT, RIGHT, TOP, BOTTOM, X
from tkinter import ttk
from game2dboard import Board
from conway.config import WIDTH, HEIGHT
from conway.grid import make_grid, step, largest_live_cluster_size, copy_grid
from conway.patterns import add_glider, add_small_exploder
...
def run(grid=None, max_generations=0):
